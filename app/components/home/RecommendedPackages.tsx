              ...
              <Link href={`/packages/${pkg.id}`}>
                <div className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden transform hover:-translate-y-2 h-full flex flex-col cursor-pointer">
                  ...
                  <div className="p-4 flex-1 flex flex-col">
                    ...
                    <h3 className="text-lg font-bold text-gray-800 group-hover:text-primary-600 transition-colors mb-2 line-clamp-2 min-h-[3rem]">
                      {pkg.title}
                    </h3>
                    ...
                    <p className="text-gray-600 text-sm mb-4 leading-relaxed line-clamp-2 flex-1 min-h-[2.5rem]">
                      {pkg.description}
                    </p>
                    ...
                    {/* CTA Button */}
                    <div className="group/btn w-full bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white py-2 px-4 rounded-xl font-medium text-sm transition-all duration-300 flex items-center justify-center space-x-2 transform hover:scale-105 mt-auto">
